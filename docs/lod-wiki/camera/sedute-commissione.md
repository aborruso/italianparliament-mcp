...
> La **composizione** (chi ne fa parte, con ruolo) NON è un `ocd:haMembro` dell'organo: si ricostruisce da due path distinti (`ocd:membro` + `ocd:ufficioParlamentare`). Vedi [[composizione-commissione]].
